"""Pure analyzer functions for Stanley Druckenmiller's investment framework.

Extracted verbatim from `stanley_druckenmiller.py` so they can be imported
without pulling in LangChain / LangGraph. The MCP server imports from here
directly; the v1 agent module continues to re-use these implementations.
"""
