"""Pure analyzer functions for Peter Lynch's investment framework.

Extracted from `peter_lynch.py` so they can be imported without pulling in
LangChain / LangGraph. The original agent module still contains the LLM
