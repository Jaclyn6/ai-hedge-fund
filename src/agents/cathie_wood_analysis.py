"""Pure analyzer functions for Cathie Wood's disruptive-innovation investment framework.

Extracted from `cathie_wood.py` so they can be imported without pulling in
LangChain / LangGraph. The original agent module can re-use these, so nothing
